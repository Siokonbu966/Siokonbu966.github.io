    ...
    <footer className="mt-auto border-t border-slate-800 px-6 py-8">
      <div className="mx-auto max-w-5xl">
        <div className="social-links">
          {socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                title={link.name}
                className="social-badges transition hover:text-blue-400"
              >
                <Icon size={32} />
              </a>
            );
          ...
          <a
            className="social-badges-x fa-twitter transition hover:text-blue-400"
          ...
          ></a>
          <a
            className="social-badges nostr-badge transition hover:text-blue-400"
